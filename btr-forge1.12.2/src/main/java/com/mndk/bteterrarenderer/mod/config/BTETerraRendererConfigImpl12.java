...
public class BTETerraRendererConfigImpl12 {

    @Config.Name(DO_RENDER_NAME)
    @Config.Comment(DO_RENDER_COMMENT)
    public static boolean doRender = DO_RENDER_DEFAULT;

    @Config.Name(MAP_SERVICE_CATEGORY_NAME)
    @Config.Comment(MAP_SERVICE_CATEGORY_COMMENT)
    public static String mapServiceCategory = MAP_SERVICE_CATEGORY_DEFAULT;

    @Config.Name(MAP_SERVICE_ID_NAME)
    @Config.Comment(MAP_SERVICE_ID_COMMENT)
    public static String mapServiceId = MAP_SERVICE_ID_DEFAULT;
    ...
    public static class HologramConfigImpl {
        ...
        public double opacity = HologramConfig.OPACITY_DEFAULT;

        @Config.Name(HologramConfig.Y_DIFF_LIMIT_NAME)
        @Config.Comment(HologramConfig.Y_DIFF_LIMIT_COMMENT)
        public double yDiffLimit = HologramConfig.Y_DIFF_LIMIT_DEFAULT;
    }
    ...
    public static class UIConfigImpl {
        ...
        public SidebarSide sidebarSide = UIConfig.SIDEBAR_SIDE_DEFAULT;
        ...
        public double sidebarWidth = UIConfig.SIDEBAR_WIDTH_DEFAULT;
        ...
        @Config.SlidingOption
        public double sidebarOpacity = UIConfig.SIDEBAR_OPACITY_DEFAULT;
    }
