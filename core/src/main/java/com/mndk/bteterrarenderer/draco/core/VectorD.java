...
public abstract class VectorD<S, SArray, V extends VectorD<S, SArray, V>>
    ...
    protected abstract DataNumberType<S, SArray> getElementType();
     ...
     */
    public <T extends CppNumber<T>, TArray> VectorD(VectorD<T, TArray, ? extends VectorD<T, TArray, ?>> srcVector) {
    ...
    public static class F2 extends VectorD<Float, float[], F2> {
        ...
        protected DataNumberType<Float, float[]> getElementType() { return DataType.float32(); }
    ...
    public static class UI2 extends VectorD<UInt, int[], UI2> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI2 create() { UInt z = UInt.ZERO; return new UI2(z, z); }
    }
    /** {@code Vector3ui} */
    public static class UI3 extends VectorD<UInt, int[], UI3> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI3 create() { UInt z = UInt.ZERO; return new UI3(z, z, z); }
    }
    /** {@code Vector4ui} */
    public static class UI4 extends VectorD<UInt, int[], UI4> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI4 create() { UInt z = UInt.ZERO; return new UI4(z, z, z, z); }
    }
    /** {@code Vector5ui} */
    public static class UI5 extends VectorD<UInt, int[], UI5> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI5 create() { UInt z = UInt.ZERO; return new UI5(z, z, z, z, z); }
    }
    /** {@code Vector6ui} */
    public static class UI6 extends VectorD<UInt, int[], UI6> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI6 create() { UInt z = UInt.ZERO; return new UI6(z, z, z, z, z, z); }
    }
    /** {@code Vector7ui} */
    public static class UI7 extends VectorD<UInt, int[], UI7> {
        ...
        protected DataNumberType<UInt, int[]> getElementType() { return DataType.uint32(); }
        protected UI7 create() { UInt z = UInt.ZERO; return new UI7(z, z, z, z, z, z, z); }
    }
}
