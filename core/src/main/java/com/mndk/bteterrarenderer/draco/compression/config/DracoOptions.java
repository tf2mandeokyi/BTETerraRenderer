...
public class DracoOptions<AttKeyT> {
    ...
    public <T> boolean getAttributeVector(AttKeyT attKey, String name, DataType<T> dataType, int numDims,
                                          BiConsumer<Integer, T> val) {
        return this.attributeOrGlobalOptions(attKey, name).getVector(name, dataType, numDims, val);
    }

    public <T> void setAttributeVector(AttKeyT attKey, String name, DataType<T> dataType, int numDims,
                                       Function<Integer, T> val) {
    ...
    public <T> boolean getGlobalVector(String name, DataType<T> dataType, int numDims, BiConsumer<Integer, T> val) {
        return globalOptions.getVector(name, dataType, numDims, val);
    }

    public <T> void setGlobalVector(String name, DataType<T> dataType, int numDims, Function<Integer, T> val) {
