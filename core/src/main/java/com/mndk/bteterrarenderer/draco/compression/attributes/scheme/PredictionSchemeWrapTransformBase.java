...
@Getter
@Setter
public class PredictionSchemeWrapTransformBase<DataT> {
    ...
    public PredictionSchemeWrapTransformBase(DataNumberType<DataT, ?> dataType) {
        ...
        this.clampedValue = CppVector.create(dataType);
    }
    ...
    public CppVector<DataT> clampPredictedValue(CppVector<DataT> predictedVal) {
    ...
    protected Status initCorrectionBounds() {
        ...
        if (dataType.and(maxDif, 1).equals(0)) {
