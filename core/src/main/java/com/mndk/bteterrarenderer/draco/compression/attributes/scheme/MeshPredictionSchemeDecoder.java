...
public abstract class MeshPredictionSchemeDecoder<DataT, CorrT> extends PredictionSchemeDecoder<DataT, CorrT> {

    private final MeshPredictionSchemeData<?> meshData;

    public MeshPredictionSchemeDecoder(PointAttribute attribute,
