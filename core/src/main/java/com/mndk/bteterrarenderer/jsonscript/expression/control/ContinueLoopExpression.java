...
@JsonDeserialize
public class ContinueLoopExpression extends JsonExpression {
    ...
    public ContinueLoopExpression(@Nullable @JsonProperty(value = "label") String label) {
        this.label = label;
    }
    ...
    protected ExpressionResult runInternal(JsonScriptRuntime runtime) {
        return ExpressionResult.continueLoop(this.label);
    }
}
