...
public enum JsonBinaryOperator implements JsonOperator {
    PLUS    ("+", OperatorType.ADDITIVE      , true, BigDecimal::add      , BigInteger::add      ),
    MINUS   ("-", OperatorType.ADDITIVE      , true, BigDecimal::subtract , BigInteger::subtract ),
    MULTIPLY("*", OperatorType.MULTIPLICATIVE, true, BigDecimal::multiply , BigInteger::multiply ),
    DIVIDE  ("/", OperatorType.MULTIPLICATIVE, true, BigDecimal::divide   , BigInteger::divide   ),
    MODULO  ("%", OperatorType.MULTIPLICATIVE, true, BigDecimal::remainder, BigInteger::remainder),
    ...
    SHIFT_LEFT       ("<<", OperatorType.SHIFT, true, (l, r) -> l.shiftLeft(r.intValue())),
    SHIFT_RIGHT_ARITH(">>", OperatorType.SHIFT, true, (l, r) -> l.shiftRight(r.intValue())),
    ...
    EQUALS    ("==", OperatorType.EQUALITY, false, JsonBinaryOperator::equalsOperation),
    NOT_EQUALS("!=", OperatorType.EQUALITY, false, JsonBinaryOperator::notEqualsOperation),

    GTE(">=", OperatorType.RELATIONAL, false, (l, r) -> l.compareTo(r) >= 0, (l, r) -> l.compareTo(r) >= 0),
    LTE("<=", OperatorType.RELATIONAL, false, (l, r) -> l.compareTo(r) <= 0, (l, r) -> l.compareTo(r) <= 0),
    GT (">",  OperatorType.RELATIONAL, false, (l, r) -> l.compareTo(r) >  0, (l, r) -> l.compareTo(r) >  0),
    LT ("<",  OperatorType.RELATIONAL, false, (l, r) -> l.compareTo(r) <  0, (l, r) -> l.compareTo(r) <  0);
    ...
    private static ExpressionResult andOperation(JsonScriptRuntime runtime, JsonExpression left, JsonExpression right) {
        ...
        return rightTransformer.getWrapped();
    }
