...
public class GuiTextFieldCopy extends GuiAbstractWidgetCopy {
    ...
    public boolean mousePressed(double mouseX, double mouseY, int mouseButton) {
        ...
        this.frame = 0;
        String s = FontManager.trimStringToWidth(this.text.substring(this.displayPos), this.getInnerWidth());
        this.moveCursorTo(FontManager.trimStringToWidth(s, i).length() + this.displayPos);
        return true;
    }
    ...
    private void drawSelectionBox(Object poseStack, int startX, int startY, int endX, int endY) {
        ...
        RawGuiManager.drawTextFieldHighlight(poseStack, startX, startY, endX, endY);
    }
