...
import com.mndk.bteterrarenderer.draco.core.MeshIOTest;
...
public class DracoDecoderTest {
    ...
    public void testSkipAttributeTransformUniqueId() {
        String fileName = "cube_att.obj";
        Mesh srcMesh = StatusAssert.assertOk(MeshIOTest.readObjFromFile(fileName));
