...
public abstract class AbstractDrawContextWrapper<T> extends MinecraftObjectWrapper<T> implements DrawContextWrapper {

    private final Stack<int[]> scissorDimStack = new Stack<>();

    protected AbstractDrawContextWrapper(@Nonnull T delegate) {
        super(delegate);
    }
    ...
    public void drawPosQuad(float x, float y, float w, float h) {
    ...
    public void drawPosTexQuad(int x, int y, int w, int h,
