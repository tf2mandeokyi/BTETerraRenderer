...
public class GraphicsQuad<T extends GraphicsVertex<T>> extends GraphicsShape<T> {
    ...
    public GraphicsQuad(Class<T> vertexClass) {
        super(vertexClass);
        this.vertices = new Object[4];
    }

    public GraphicsQuad(Class<T> vertexClass, T v0, T v1, T v2, T v3) {
        super(vertexClass);
    ...
    public static GraphicsQuad<PosTexNorm> newPosTexNorm(PosTexNorm v0, PosTexNorm v1, PosTexNorm v2, PosTexNorm v3) {
        return new GraphicsQuad<>(PosTexNorm.class, v0, v1, v2, v3);
    }
