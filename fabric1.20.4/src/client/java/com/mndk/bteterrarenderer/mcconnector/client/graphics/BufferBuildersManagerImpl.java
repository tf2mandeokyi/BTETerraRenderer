...
public class BufferBuildersManagerImpl implements BufferBuildersManager {
    ...
    // TODO: Fix begin3dTri not appearing at all
    ...
    private void nextVertex(MatrixStack.Entry entry, VertexConsumer consumer, McCoord pos, float u, float v, float alpha) {
