...
public class GuiCheckBoxCopy extends GuiAbstractWidgetCopy {
    ...
    public GuiCheckBoxCopy(int x, int y, String text, boolean checked) {
        super(x, y, BOX_WIDTH + BOX_MARGIN_RIGHT + FontManager.getStringWidth(text), BOX_HEIGHT, text);
    ...
    public void drawComponent(Object poseStack) {
        ...
        RawGuiManager.drawCheckBox(poseStack, x, y, BOX_WIDTH, height, this.isFocused(), checked);
        ...
        FontManager.drawStringWithShadow(poseStack, text, this.x + BOX_WIDTH + BOX_MARGIN_RIGHT, this.y + 2, color);
    }
