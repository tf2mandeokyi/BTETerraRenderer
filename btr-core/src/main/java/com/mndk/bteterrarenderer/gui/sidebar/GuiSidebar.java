...
public class GuiSidebar extends AbstractGuiScreen {
    ...
    protected void drawScreen(Object poseStack) {
        ...
        GraphicsConnector.INSTANCE.glTranslate(poseStack, translateX, this.paddingTopBottom - verticalSliderValue, 0);
    ...
    private void drawSidebarBackground(Object poseStack) {
        ...
        GuiStaticConnector.INSTANCE.fillRect(poseStack, range[0], 0, range[1], height, SIDEBAR_BACKGROUND_COLOR);
        ...
        GuiStaticConnector.INSTANCE.fillRect(poseStack, widthChangeBarX - 1, 0, widthChangeBarX, height,
                this.side == SidebarSide.LEFT ? changeBarShadow : changeBarColor);
        GuiStaticConnector.INSTANCE.fillRect(poseStack, widthChangeBarX, 0, widthChangeBarX + 1, height,
