...
public class GuiIntegerSlider implements GuiSliderConnector {


    private final GuiSliderConnector parent;
    ...
    public GuiIntegerSlider(
        ...
        this.parent = Connectors.SUPPLIER.newGuiSlider(
    ...
    private void drawSliderPositionBox() {
        Connectors.GUI.drawContinuousTexturedBox(parent.getButtonTextures(),
    ...
    @Override public int getDisplayString() { return parent.getDisplayString(); }
    ...
    @Override public float getSliderValue() { return parent.getSliderValue(); }
    @Override public int getValueInt() { return parent.getValueInt(); }
    @Override public ResourceLocationConnector getButtonTextures() { return parent.getButtonTextures(); }
    ...
    @Override public void setSliderValue(float sliderValue) { parent.setSliderValue(sliderValue); }
