...
public class RawGuiManagerMixin {
    ...
    @Overwrite
    private static RawGuiManager<PoseStack> makeInstance() { return new RawGuiManager<>() {

        public void displayGuiScreen(AbstractGuiScreenCopy gui) {
            Minecraft.getInstance().setScreen(new AbstractGuiScreenImpl(gui));
        }

        public void drawButton(PoseStack poseStack, int x, int y, int width, int height, GuiAbstractWidgetCopy.HoverState hoverState) {
        ...
        public void drawCheckBox(PoseStack poseStack, int x, int y, int width, int height, boolean focused, boolean checked) {
            RenderSystem.setShader(GameRenderer::getPositionTexShader);
        ...
        public void drawTextFieldHighlight(PoseStack poseStack, int startX, int startY, int endX, int endY) {
        ...
        public void drawImage(PoseStack poseStack, IResourceLocation res, int x, int y, int w, int h, float u1, float v1, float u2, float v2) {
            RenderSystem.setShader(GameRenderer::getPositionTexShader);
